...
public class CJoinDialog extends JoinDialog {
    ...
    private void loadServers(){
        ...
        if(Core.settings.has("server-list")){
            Seq<Server> tmp =new Seq<>();
            for (JoinDialog.Server s:LegacyIO.readServers()){
                tmp.add((Server)s);
            }
            servers = tmp;
        ...
        String url = becontrol.active() ? serverJsonBeURL : serverJsonURL;
    ...
    public static class Server extends JoinDialog.Server{
        public String ip;
        public int port;
